...
/**
 * Servlet implementation class Telegraph
 */
@WebServlet("/Telegraph")
public class Telegraph extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Date date = new Date();
		Document document = Jsoup.connect("http://www.telegraph.co.uk/theresa-may/").get();
